...
export default class implements IStructureHelper {
    static GetMemory(id:string): DoubleCRUDResult<StructureMemory,StructureCache> {
        const result: DoubleCRUDResult<StructureMemory,StructureCache> = {success:false, memory:undefined, cache:undefined};
    ...
    static CreateMemory(id:string, memory:StructureMemory, cache:StructureCache): DoubleCRUDResult<StructureMemory,StructureCache> {
        const result: DoubleCRUDResult<StructureMemory,StructureCache> = {success:false, memory:undefined, cache:undefined};
    ...
    static DeleteMemory(id:string, isMemory:boolean, isCache:boolean): DoubleCRUDResult<StructureMemory,StructureCache> {
        const result: DoubleCRUDResult<StructureMemory,StructureCache> = {success:false, memory:undefined, cache:undefined};
        if (isMemory) {
    ...
    static UpdateMemory(id:string, memory?:StructureMemory, cache?:StructureCache): DoubleCRUDResult<StructureMemory,StructureCache> {
        const result: DoubleCRUDResult<StructureMemory,StructureCache> = {success:false, memory:undefined, cache:undefined};
    ...
    static Initialize(data:StructureInitializationData): DoubleCRUDResult<StructureMemory,StructureCache> {
    const id = data.structure.id;
    const result: DoubleCRUDResult<StructureMemory,StructureCache> = {success:false, memory:undefined, cache:undefined};
        ...
        const cacheResult = IStructureCache.Initialize(id, data.structure,data.executer);
        if (cacheResult.success) {
            result.success = true;
            result.cache = cacheResult.data;
        }
